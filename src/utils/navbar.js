...
export const Navbar = () => (
  <nav className="border-bottom d-flex justify-content-between py-3 mb-4 nav-bg px-custom">
    <div className="d-flex align-items-center">
      ...
      <a className="mx-3 text-secondary" href="https://bookstore-jude-bereket.herokuapp.com/">Books</a>
      <a className="mx-3 text-secondary" href="https://bookstore-jude-bereket.herokuapp.com/">Categories</a>
    </div>
    <div className="d-flex align-items-center">
