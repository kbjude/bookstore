...
const Book = ({ id, title, category, onRemove }) => (
    ...
    <div className="row mx-0">
      <div className="card-body col-12 col-md-4 ">
        ...
        <div className="btn-group" role="group" aria-label="Basic example">
          ...
          <button type="button" className="btn border-left border-right" onClick={() => onRemove({ id, title, category })}>
            Remove
          </button>
          <button type="button" className="btn">
            Edit
      ...
      <div className="card-body row mx-0 col-4 col-md-4 border">
      ...
      <div className="card-body d-flex flex-column col-4 col-md-4 ">
        ...
        <p>Chapter 1</p>
        <button className='btn btn-info w-50 disabled'>Update Progress</button>
      </div>
    </div>
  </div>
);
